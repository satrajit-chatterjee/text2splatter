...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/data/satrajic/saved_models/text-3d-diffusion/lora/unet",
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                latents = vae.encode(batch[1].to(dtype=weight_dtype)).latent_dist.sample()
                ...
                encoder_hidden_states = text_encoder(batch[0], return_dict=False)[0]
